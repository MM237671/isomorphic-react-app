      ...
      <section className="content">
        ...
        <div className="wrapBlock maxWidth40">
          <div id="content">
            ...
            <p>Все они живут и работают в городе Тарусе Калужской области. Место это не то чтобы знаменитое, но отмечено любовью таких людей как Марина Цветаева, Константин Паустовский, Святослав Рихтер и других деятелей искусства.</p><p>По поводу любых интересующих вас вопросов вы можете обращаться по электронной почте <a href="mailto:medvedb24@yandex.ru">medvedb24@yandex.ru</a> или писать в instgram. Вы так же можете посетить <Link to="/places">салоны и галереи,</Link> где находится художественные работы.<br />Приятного просмотра.</p>
          </div>
        </div>
      </section>
    );
