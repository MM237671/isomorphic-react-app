    ...
    if (redirectLocation) {
      ...
      const metaData = {
        ...
        '/artist/PilipenkoTonya': {
          ...
          title: 'Художник Пилипенко Антонина - акварель/пастель Художники из города Таруса',
        ...
        '/artist/PilipenkoMihail': {
          ...
          title: 'Художник Пилипенко Михаил - живопись (холст/масло), горячая эмаль, Художники из города Таруса',
        ...
        '/artist/PilipenkoViktoriya': {
          ...
          title: 'Художник Пилипенко Виктория - батик (роспись по шелку), Художники из города Таруса',
        ...
        '/artist/PilipenkoSergey': {
          ...
          title: 'Художник Пилипенко Сергей - скульптура (дерево/тонировка), Художники из города Таруса',
        ...
        '/artist/RostemberskayaGalina': {
          ...
          title: 'Художник Ростемберская Галина - живопись (холст/масло), Художники из города Таруса',
