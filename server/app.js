    ...
    if (redirectLocation) {
      ...
      const metaData = {
        '/': {
          ...
          keywords: 'Художники Тарусы,Живопись,Графика,Эмаль,Скульптура,Батик,Ремесло,Холст,Масло,Дерево,Шелк,Роспись',
        },
        '/exhibition': {
        ...
        '/places': {
          description: 'Салоны и галереи где вы можете купить работы художников',
          title: 'Салоны и галереи - Художники Тарусы - Купить работы',
          keywords: 'Салоны,Галерея,Купить работы,Художники Тарусы',
        },
        ...
        '/artist/PilipenkoTonya': {
          ...
          keywords: 'Пилипенко Антонина,Художники Тарусы,Живопись,Акварель,Пастель,',
        },
        '/artist/PilipenkoMihail': {
          ...
          keywords: 'Пилипенко Михаил,Художники Тарусы,Живопись,Эмаль,Холст,Масло',
        },
        '/artist/PilipenkoViktoriya': {
          ...
          keywords: 'Пилипенко Виктория,Художники Тарусы,Батик,Роспись,Шелк',
        },
        '/artist/PilipenkoSergey': {
          ...
          keywords: 'Пилипенко Сергей,Художники Тарусы,Скульптура,Дерево,Тонировка',
        },
        '/artist/RostemberskayaGalina': {
          ...
          keywords: 'Ростемберская Галина,Художники Тарусы,Живопись,Холст,Масло',
        }
      };
